...
const Cement = () => {
  ...
  const skills = [
    { icon: Reactjs, label: userData.labels[0] },
    { icon: Nextjs, label: userData.labels[1] },
    { icon: JavaScript, label: userData.labels[2] },
    { icon: MaterialUI, label: userData.labels[3] },
  ];

  return (
    <div className="bg-gradient-to-br from- bg-stone-800 to-[#121212] text-[#E0E0E0] p-6 rounded-xl shadow-2xl max-w-sm mx-auto transition-all duration-300 hover:scale-105">
